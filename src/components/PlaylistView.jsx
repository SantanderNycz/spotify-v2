...
import { getTracksForPlaylist, getArtistById } from '../data/mockData';
      ...
      >
        ...
        >
          ...
          <div className="text-white pb-2 animate-slide-up">
            <p className="text-xs font-bold uppercase tracking-widest mb-2 opacity-80">Playlist</p>
            <h1 className="text-5xl font-black mb-4 leading-tight">{playlist.name}</h1>
            ...
            <div className="flex items-center gap-1 text-sm">
              ...
              <span className="text-[#b3b3b3]">{playlist.followers} curtidas</span>
              <span className="text-[#b3b3b3]">•</span>
