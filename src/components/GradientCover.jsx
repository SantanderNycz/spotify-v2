...
export default function GradientCover({ gradient, icon, className = '', rounded = false }) {
  const bg = gradient && gradient.length >= 2
  ...
  return (
    <div
      ...
      style={{ background: bg }}
    >
      {icon === 'heart' && <Heart className="text-white w-2/5 h-2/5" fill="white" />}
