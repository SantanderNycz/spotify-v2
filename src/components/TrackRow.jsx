...
function Equalizer({ playing }) {
  if (!playing)
    return <span className="text-[#1ed760] text-sm font-bold">▶</span>;
  return (
...
export default function TrackRow({
  ...
  return (
    <div
      ...
      style={{
        gridTemplateColumns: showAlbum ? "16px 4fr 2fr 1fr" : "16px 1fr 1fr",
      }}
        ...
        <button
          ...
          className={`transition-all hover:scale-110 ${
            liked
              ...
              : "text-[#b3b3b3] opacity-0 group-hover:opacity-100"
          }`}
        >
