...
export const playlists = [
  {
    id: "pl1",
    name: "Chill Hits",
    description: "Relaxa e aproveita as melhores faixas do momento.",
  ...
  },
  {
    id: "pl2",
    name: "Beast Mode",
    description: "Ligue o modo fera. Hip-hop pesado para os treinos.",
    gradient: ["#e91429", "#5f1010"],
    trackIds: ["t5", "t6", "t7", "t8", "t11", "t12"],
    owner: "Spotify",
    followers: "4.821.903",
  },
  {
    id: "pl3",
    name: "Happy Hits!",
    description: "Hits para animar o seu dia e encher o coracao.",
  ...
  },
  {
    id: "pl4",
    name: "Vibe On",
    description: "Descontraido com as faixas mais populares.",
    gradient: ["#148a08", "#0f3006"],
    trackIds: ["t2", "t6", "t7", "t12", "t4", "t8"],
    owner: "Spotify",
    followers: "3.412.009",
  },
  {
    ...
    description: "A banda sonora perfeita para uma corrida noturna.",
  ...
  },
  {
    id: "pl6",
    name: "Mega Hit Mix",
    description: "O maior mix dos maiores hits.",
    gradient: ["#7358ff", "#350979"],
    trackIds: ["t5", "t7", "t9", "t11", "t1", "t6"],
    owner: "Spotify",
    followers: "15.760.444",
  },
];
...
export const madeForYou = [
  ...
  },
  {
    id: "mix2",
    name: "Daily Mix 2",
    description: "Kendrick Lamar, J. Cole, Tyler e mais",
    gradient: ["#1e3264", "#4b917d"],
    trackIds: ["t7", "t8", "t5", "t6"],
  },
  {
    id: "mix3",
    name: "Daily Mix 3",
    description: "Taylor Swift, Olivia Rodrigo e mais",
  ...
  },
  {
    id: "mix4",
    name: "Daily Mix 4",
    description: "Bad Bunny, J Balvin, Ozuna e mais",
    gradient: ["#f59b23", "#e61e32"],
    trackIds: ["t11", "t12", "t5", "t6"],
  },
  {
    id: "mix5",
    name: "Daily Mix 5",
    description: "Harry Styles, Doja Cat, SZA e mais",
    gradient: ["#2d46b9", "#f074b4"],
    trackIds: ["t9", "t10", "t7", "t8"],
  },
  {
    id: "rr",
    name: "Release Radar",
